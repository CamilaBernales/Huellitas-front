...
export default function Turnosadmin() {
  ...
  const onClickGuardar = () => {
    const turnosFilt = turnos.filter(
      (turno) => turno.idTurno !== editar.idTurno
    );
    ...
    <Fragment>
      ...
      <Container className="d-flex flex-column justify-center py-5">
        <Row className="m-0 d-flex align-items-end">
          ...
          <Col>
            <label htmlFor="servicio" className="mb-0">
              Servicio
            </label>
            <InputGroup className="mb-4" size="sm">
              <FormControl
          ...
          <Col>
            <label htmlFor="fecha" className="mb-0">
              Fecha
            </label>
            <InputGroup className="mb-4" size="sm">
              <FormControl
          ...
          <Col>
            <label htmlFor="hora" className="mb-0">
              Hora
            </label>
            <InputGroup className="mb-4" size="sm">
              <FormControl
