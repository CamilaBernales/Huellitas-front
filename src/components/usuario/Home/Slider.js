    ...
    <Carousel className="carousel">
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <Button href="/equipo" size="lg" className="btn-custom-slider">
            <strong>
              Conocenos
            </strong>
          </Button>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <Button href="/turno" size="lg" className="btn-custom-slider">
            <strong>
              Solicitar turno
            </strong>
          </Button>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <Button href="/tienda" size="lg" className="btn-custom-slider">
            <strong>
              Comprar
            </strong>
          </Button>
